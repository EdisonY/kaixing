...
const getters = {
    ...
    emeconfirmData(state){
        return state.emeconfirm
    },
}
const mutations = {
    ...
    get_emeconfirmData(state, data) {
        state.emeconfirm = data
    },
}
const actions = {
    ...
    getEmeconfirmData({ commit }, data) {
        commit("get_emeconfirmData", data);
    }
}
export default {
    namespaced: true,
