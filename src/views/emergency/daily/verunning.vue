            ...
            <el-table :data="tableData"
                ...
                <el-table-column prop="date"
                    ...
                    <template slot-scope="scope">
                        <el-link v-if="scope.row.date == '站台滞留人数告警'"
                            type="danger"
                            @click="showAlert(scope.row)">{{ scope.row.date }}</el-link>
                ...
                <el-table-column prop="xinxi"
                    align="center"
                    label="告警位置">
                </el-table-column>
                <el-table-column prop="duishu"
                    align="center"
                    label="告警持续时间">
                </el-table-column>
            </el-table>
        ...
        <el-dialog title="站台滞留人数告警"
            ...
            <span slot="footer"
                ...
                <el-button type="success"
                    v-if="isIndeterminate || checkAll"
                    @click="ph('站场通知成功！')">通知站场</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
.verunning .selfTable tr {
    line-height: 40px;
}
.verunning .selfTable tr:hover,
.verunning .selfTable .thead {
    background-color: #f5f7fa;
}
.verunning .selfTable tr td,
.verunning .selfTable tr th {
    border-right: 1px solid #ebeef5;
    border-top: 1px solid #ebeef5;
    text-align: center;
    position: relative;
}
.verunning .selfTable tr td label,
.verunning .selfTable tr th label {
    position: absolute;
    left: 5px;
}
</style>